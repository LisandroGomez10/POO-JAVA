...
public class AplicacionFacultad {
    ...
    public static void main(String[] args) {
        // Se crea un profesor inicial para pasar al constructor de Facultad
        Profesor profesorInicial = crearProfesorInicial();
        Facultad unne = new Facultad("UNNE", profesorInicial);
    ...
    // Método para crear el profesor inicial
    private static Profesor crearProfesorInicial() {
        System.out.println("Por favor, ingrese los datos del profesor inicial.");
        return crearProfesor();
    }

    // Método para crear un profesor nuevo
