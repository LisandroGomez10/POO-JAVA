...
public class Banco {
    public static void main(String[] args) {
        ...
        System.out.print("Ingrese el Mes de nacimiento del titular (1-12): ");
        ...
        CajaDeAhorro caja1 = new CajaDeAhorro(1234, persona1, saldoInicial,300000);
        
        // Crear CuentaCorriente con datos predefinidos
        CuentaCorriente cuenta = new CuentaCorriente(1735, per1,4000,500000);
        ...
        caja1.mostrar();
        caja1.extraer(41000); // Intentar extraer un monto mayor al límite
        caja1.mostrar();
